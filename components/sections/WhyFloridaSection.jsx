...
export default function WhyFloridaSection() {
  return (
        ...
        <div className="w-full lg:max-w-[400px] xl:max-w-[480px] 2xl:max-w-[800px] ml-0 lg:ml-20 lg:mr-0 lg:pr-12 xl:pr-20 2xl:pr-28">
          ...
          <div className="overflow-hidden pb-1 mb-6">
            <motion.h2
              ...
              className="font-heading text-3xl md:text-4xl lg:text-5xl xl:text-[3.5rem] text-[#332820] tracking-tight "
            >
              WE SHAPE THE ESSENCE OF LIVING
            </motion.h2>
          </div>
