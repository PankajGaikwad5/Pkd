          ...
          <div className="flex flex-col gap-10">
            <FadeIn delay={0.4}>
              <div>
                ...
                <p
                  ...
                  className="text-[15px] text-[#D6CBBC]/90 text-justify font-light leading-relaxed normal-case font-sans select-text cursor-pointer hover:opacity-75 transition-opacity duration-300"
                >
                ...
                <a
                  ...
                  className="inline-block mt-2 text-[11px] tracking-wider text-[#D6CBBC]/60 hover:text-white transition-colors duration-300 font-sans uppercase underline underline-offset-4"
                >
                  Get Directions ↗
                </a>
              </div>
            ...
            <FadeIn delay={0.6}>
              <div>
                ...
                <ul className="space-y-2 text-[15px] text-[#D6CBBC]/90 font-light normal-case font-sans">
          ...
          <div className="flex flex-col gap-10">
            <FadeIn delay={0.45}>
              <div>
                ...
                <p className="text-[15px] text-[#D6CBBC]/90 font-light normal-case font-sans">
